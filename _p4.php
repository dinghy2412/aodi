...
<html>
	...
	<body>
		<img src="http://img.xiyoumai.com/aodiQRcode.jpg" style="width: 100px; height: 100px; position: absolute; bottom: 8px; left: 50%; margin-left: -50px" alt="">
		<form method="POST" id="Label_Form" onsubmit="return false;" name="Label_Form" style="height: 100%;">
		<div class="leaveInfoBg">
			<!--<div class="jiathis_style_m"></div>-->
			<div class="headImg" style="margin: 15% 0 0 13%;"></div>
<div style="text-align: center; font-size: 14px; color: #fff; margin-top: -7px;">北京奥吉通汽车销售有限公司</div>
			<div class="mainInfo" style="margin: 0 auto">
